...
module.exports = class StaffResourceLeasingInformationController {
  ...
  static get_specific_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.get_specific_records(
        ColumnName,
        value_
      );
  ...
  static batch_update(jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.batch_update(
        jsonObject_
      );
  ...
  static individual_record_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.individual_record_update(
        ColumnName,
        value_,
        jsonObject_
      );
  ...
  static delete_user_specic_record(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.delete_user_specic_record(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static get_number_of_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.get_number_of_records(
        ColumnName,
        value_
      );
  ...
  static user_specific_select_query(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = StaffResourceLeasingInformationModel.user_specific_select_query(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
