...
module.exports = class ActualTermsController {
  ...
  static individual_record_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = ActualTermsModel.individual_record_update(
        ColumnName,
        value_,
        jsonObject_
      );
  ...
  static delete_user_specic_record(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ActualTermsModel.delete_user_specic_record(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static get_number_of_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = ActualTermsModel.get_number_of_records(
        ColumnName,
        value_
      );
  ...
  static user_specific_select_query(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ActualTermsModel.user_specific_select_query(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static get_all_current_year_terms(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ActualTermsModel.get_all_current_year_terms(
        TableOne,
        JoiningKey,
        SearchColumn,
        SearchValue
