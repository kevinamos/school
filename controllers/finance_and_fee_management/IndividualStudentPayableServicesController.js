...
module.exports = class IndividualStudentPayableServicesController {
  ...
  static get_specific_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.get_specific_records(
        ColumnName,
        value_
      );
  ...
  static batch_update(jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.batch_update(
        jsonObject_
      );
  ...
  static individual_record_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.individual_record_update(
        ColumnName,
        value_,
        jsonObject_
      );
  ...
  static delete_user_specic_record(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.delete_user_specic_record(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static get_number_of_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.get_number_of_records(
        ColumnName,
        value_
      );
  ...
  static user_specific_select_query(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = IndividualStudentPayableServicesModel.user_specific_select_query(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
