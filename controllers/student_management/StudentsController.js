...
const StudentsModel = require("../../models/student_management/StudentsModel.js");
...
module.exports = class StudentsController {
  ...
  static get_specific_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StudentsModel.get_specific_records(ColumnName, value_);
  ...
  static get_number_of_records(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      var myPromise = StudentsModel.get_number_of_records(ColumnName, value_);
  ...
  static get_students_class_levels_from_classId(
    TableOne,
    TableTwo,
    JoiningKeyOne,
    JoiningKeyTwo,
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = StudentsModel.get_students_class_levels_from_classId(
        TableOne,
        TableTwo,
        JoiningKeyOne,
        JoiningKeyTwo,
