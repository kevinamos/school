...
module.exports = class MeanGradeController {
  ...
  static individual_record_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = MeanGradeModel.individual_record_update(
        ColumnName,
        value_,
        jsonObject_
      );
  ...
  static delete_user_specic_record(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = MeanGradeModel.delete_user_specic_record(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static user_specific_select_query(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = MeanGradeModel.user_specific_select_query(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static select_mean_grade_for_particular_mean_for_particular_class_level(
    ColumnNameOne,
    ValueOne,
    ValueTwo,
    ColumnTwo,
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = MeanGradeModel.select_mean_grade_for_particular_mean_for_particular_class_level(
        ColumnNameOne,
        ValueOne,
        ValueTwo,
        ColumnTwo,
