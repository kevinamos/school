...
module.exports = class ExamPapersController {
  ...
  static individual_record_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.individual_record_update(
        ColumnName,
        value_,
        jsonObject_
      );
  ...
  static delete_user_specic_record(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.delete_user_specic_record(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static user_specific_select_query(
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.user_specific_select_query(
        ColumnName,
        value_,
        UserIdColumnName,
        UserId
  ...
  static innerjoin_classSpecifSubjects_with_ExamPapers(
    TableOne,
    JoiningKey,
    SearchColumn,
    SearchValue
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.innerjoin_classSpecifSubjects_with_ExamPapers(
        TableOne,
        JoiningKey,
        SearchColumn,
        SearchValue
  ...
  static get_a_classSpecicSubject_exam_paper_for_a_specific_exam(
    ColumnNameOne,
    ValueOne,
    ColumnNameTwo,
    ValueTwo
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.get_a_classSpecicSubject_exam_paper_for_a_specific_exam(
        ColumnNameOne,
        ValueOne,
        ColumnNameTwo,
        ValueTwo
  ...
  static get_exam_papers_assignable_to_particular_student(
    TableOne,
    JoiningKey,
    SearchColumnOne,
    SearchValueOne,
    ...
    return new Promise(function(resolve, reject) {
      var myPromise = ExamPapersModel.get_exam_papers_assignable_to_particular_student(
        TableOne,
        JoiningKey,
        SearchColumnOne,
        SearchValueOne,
