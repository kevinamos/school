...
router.post("/add_class_specific_subjects", urlencodedParser, function(
  request,
  response
) {
  var jsonObject_ = {
...
router.post("/get_all_class_specific_subjects", urlencodedParser, function(
  request,
  response
) {
...
router.post("/get_specific_class_specific_subjects", urlencodedParser, function(
  request,
  response
) {
  ...
  var myPromise = ClassSpecificSubjectsController.get_specific_records(
    mKey,
    mValue
  );
...
router.post("/update_class_specific_subjects", urlencodedParser, function(
  request,
  response
) {
  var jsonObject_ = {
...
router.post(
  "/update_individual_class_specific_subjects",
  urlencodedParser,
  function(request, response) {
    ...
    var myPromise = ClassSpecificSubjectsController.individual_record_update(
      column_name,
      value_,
      jsonObject_
    );
...
router.post(
  "/delete_individual_class_specific_subjects",
  urlencodedParser,
  function(request, response) {
    ...
    var myPromise = ClassSpecificSubjectsController.delete_user_specic_record(
      column_name,
      value_,
      UserIdColumnName,
      UserId
...
router.post(
  "/get_number_of_class_specific_subjects_records",
  urlencodedParser,
  function(request, response) {
    var column_name = request.body.column_name;
    //var mValue=parseInt(request.body.search_value, 10);
    ...
    var myPromise = ClassSpecificSubjectsController.get_number_of_records(
      column_name,
      value_
    );
...
router.post(
  "/class_specific_subjects_user_specific_query",
  urlencodedParser,
  function(request, response) {
    ...
    var myPromise = ClassSpecificSubjectsController.user_specific_select_query(
      ColumnName,
      value_,
      UserIdColumnName,
      UserId
...
*/
router.post(
  "/get_a_specific_class_subjects_by_full_reference",
  urlencodedParser,
  function(request, response) {
    ...
    var myPromise = ClassSpecificSubjectsController.get_a_specific_class_subjects_by_full_reference(
      TableOne,
      JoiningKey,
      SearchColumn,
      SearchValue
...
*/
router.post(
  "/get_all_class_subjects_by_full_reference",
  urlencodedParser,
  function(request, response) {
    ...
    var myPromise = ClassSpecificSubjectsController.get_all_class_subjects_by_full_reference(
      TableTwo,
      TableThree,
      TableFour,
      TableFive,
