...
router.post("/get_specific_fields_", urlencodedParser, function(
  request,
  response
) {
...
router.post("/update_individual_fields_", urlencodedParser, function(
  request,
  response
) {
  ...
  var myPromise = FieldsController.individual_record_update(
    column_name,
    value_,
    jsonObject_
  );
...
router.post("/delete_individual_fields_", urlencodedParser, function(
  request,
  response
) {
  ...
  var myPromise = FieldsController.delete_user_specic_record(
    column_name,
    value_,
    UserIdColumnName,
    UserId
...
router.post("/get_number_of_fields__records", urlencodedParser, function(
  request,
  response
) {
  var column_name = request.body.column_name;
...
router.post("/fields__user_specific_query", urlencodedParser, function(
  request,
  response
) {
  ...
  var myPromise = FieldsController.user_specific_select_query(
    ColumnName,
    value_,
    UserIdColumnName,
    UserId
...
router.post("/get_a_students_Fields", urlencodedParser, function(
  request,
  response
) {
